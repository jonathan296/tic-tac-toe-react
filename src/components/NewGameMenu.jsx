...
function ToggleButton() {
  ...
  const [playeSelect, setPlayerSelect] = useState(null);
  const toggle = () => {
        ...
        <div className=" h-[471px] w-[460px]">
          ...
          <div className="h-[205px] bg-[#1F3641] mt-[40px] rounded-[15px] shadow-[0px_-8px_0px_#10212A_inset] ">
            ...
            <div className="bg-[#1A2A33] w-[412px] h-[72px] mx-auto rounded-[10px] mb-[17px] p-[9px] flex">
              <button className=" w-1/2 h-full rounded-[10px] flex flex-row items-center justify-center hover:bg-opacity-5 hover:bg-[#A8BFC9]">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
              ...
              <button className="bg-[#A8BFC9] w-1/2 h-full rounded-[10px] flex flex-row items-center justify-center">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
          ...
          <button className=" h-[67px] bg-[#F2B137] mt-[40px] rounded-[15px] font-bold shadow-[0px_-8px_0px_#CC8B13_inset] font-outfit w-full pb-2 text-[20px] text-[#1A2A33]">
            NEW GAME (VS CPU)
          </button>
          <button className="h-[67px] bg-[#31C3BD] mt-[20px] rounded-[15px] font-bold shadow-[0px_-8px_0px_#118c87_inset] font-outfit w-full pb-2 text-[20px] text-[#1A2A33]">
            NEW GAME (VS PLAYER)
          </button>
        </div>
      </div>
